...
return {
	ACTIONFAIL =
	{
		SHAVE =
		{
			AWAKEBEEFALO = "That's really not a good idea.",
			GENERIC = "I just can't!",
        ...
        GIVE =
        {
            DEAD = "Maybe i'll keep this.",
            SLEEPING = "Poke Poke. They're too sleepy.",
            BUSY = "I'll try again in a second.",
        },
        GIVETOPLAYER = 
        {
        	FULL = "You have too much shit!",
            DEAD = "They dont need this.",
            SLEEPING = "Poke Poke. They're too sleepy.",
            BUSY = "I'll try again in a second.",
    	},
    	GIVEALLTOPLAYER = 
        ...
        {
            GENERIC = "I can't do that.",
            INUSE = "They have better handwriting anyways...",
        },
        CHANGEIN =
        {
            GENERIC = "I can't do that.",
        ...
        ATTUNE =
        {
            NOHEALTH = "Not tonight honey, I dont feel good.",
        },
	},
	...
	ANNOUNCE_BOOMERANG = "Ow! DANG boomerANG... hehe.",
	...
	ANNOUNCE_EAT =
	{
		...
		SPOILED = "Bleh!",
		STALE = "I hate stale chips!",
		INVALID = "That is not food. I'm no Alex!",
		YUCKY = "That's not going anywhere near my mouth!",
	},
	...
	ANNOUNCE_HUNGRY = "I gould go for a burger!",
    ...
    ANNOUNCE_NODANGERGIFT = "I'll wait till it's safe...",
	ANNOUNCE_NODANGERSLEEP = "I can't sleepat a time like this!",
	ANNOUNCE_NODAYSLEEP = "I can't nap in th middle of the day.",
	...
	ANNOUNCE_SHELTER = "At least trees are good for something!",
	ANNOUNCE_THORNS = "Ow!",
	ANNOUNCE_BURNT = "You're FIRED!",
	ANNOUNCE_TORCH_OUT = "Aaand now it's dark!",
	...
	ANNOUNCE_WORMHOLE = "Well... that went well.",
	...
	DESCRIBE =
	{
		...
		BERNIE_ACTIVE = "That's fucking terrifying.",
        ...
        ANCIENT_ALTAR = "Old and dusty.",

        ANCIENT_ALTAR_BROKEN = "I'ts broken, just like everything else in this damn house.",
		...
		CAVE_BANANA = "BaBaBa BaNaNaNa.",
		CAVE_BANANA_COOKED = "BABABA BANANANA!",
		...
		BIRDTRAP = "Gives me a NET advantage... hehe",
		BIRD_EGG = "A small, normal egg.",
		BIRD_EGG_COOKED = "Scrambled is best!",
		...
		BONESTEW = "BONE appetit... hehe!",
		BUGNET = "For catching bugs.",
		BUSHHAT = "Call me George W.! hehe",
		...
		BUTTERFLYMUFFIN = "Mmm BUTTERy... hehe!",
		BUTTERFLYWINGS = "Without these, it's just a BUTTER... hehe.",
		...
		CATCOONDEN = 
		{
			GENERIC = "Ewe. I don't like cats.",
			EMPTY = "Good. it's empty.",
		},
		CATCOONHAT = "A dead cat's a great hat",
		COONTAIL = "They're better this way.",
		CARROT = "I don't CARROT-all about CARROTS... hehe.",
		CARROT_COOKED = "Mushy.",
		CARROT_PLANTED = "The earth is making plantbabies.",
		CARROT_SEEDS = "It's a seed.",
		WATERMELON_SEEDS = "WATERMELOAAN.",
		...
		CORN = "I bet you expect me to make a CORNY joke huh?",
		CORN_COOKED = "Where's the cob?",
		...
		DEERCLOPS_EYEBALL = "EYE hate these things... hehe.",
		...
		BIRCHNUTDRAKE = "A NUTS little nut... hehe",
		EVERGREEN =
		{
			BURNING = "What a waste of wood.",
			BURNT = "I feel like I could have prevented that.",
		...
		FIREFLIES =
		{
			...
			HELD = "I got a pocketfull a pocketfulla sunshine!",
		},
		FIREHOUND = "That's a HOT DOG if I ever saw one... hehe",
		FIREPIT =
		{
			EMBERS = "I should put something on the fire before it goes out.",
			GENERIC = "Sure beats darkness.",
		...
		FIRESTAFF = "I just wanna to set the world on fire!",
		FIRESUPPRESSOR = 
		{	
			ON = "Fling on!",
		...
		HEATROCK =
		{
			FROZEN = "Cold. As. Ice. You know that you are.",
		...
		HOUND = "You ain't nothing but a HOUND DOG... HEHE",
		HOUNDBONE = "Creepy.",
		...
		LIGHTNING_ROD =
		{
			CHARGED = "The power is mine! MWAHAHA",
		...
		MINERHAT = "HAT'S OFF to whoever invented this... hehe",
		MONKEY = "Curious little guy.",
		MONKEYBARREL = "Stop MONKEYING around... hehe",
		...
		NIGHTMAREFUEL = "This is the stuff of NIGHTMARES... hehe",
		...
		PIGHOUSE =
		{
			...
			LIGHTSOUT = "Come ON! I wanna BLT... without the T.",
			BURNT = "Not so fancy now, pig!",
		},
		PIGKING = "Ewwww, he smells!",
		PIGMAN =
		{
			DEAD = "A waste of bacon.",
		...
		TALLBIRDEGG_COOKED = "Alex is gonna be REAL mad...",
		TALLBIRDEGG_CRACKED =
		{
			COLD = "Brrrr!",
		...
		WATERMELON = "WatermeALOAN",
		WATERMELON_COOKED = "Juicy and warm.",
		WATERMELONHAT = "THEY GOT HELMETS ON THEY HEADS!",
